...
function Header() {
    ...
    function inputSubmit(e) {
        e.preventDefault();
        navigate(`/search/${searchTerm}`, { state: { status_code: [] } });
    }
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent" style={{ "justifyContent": "space-evenly" }}>
                <ul className="navbar-nav mr-auto" style={{ "justifyContent": "space-evenly" }}>
                    ...
                    <li className="nav-item">
                        <NavLink className="nav-link" to="/search" state={{ status_code: [1, 2] }}>Applied Jobs</NavLink>
                    </li>
                    <li className="nav-item">
                ...
                <div className="form-inline my-2 my-lg-0">
                    ...
                    <Link to={`/search/${searchTerm}`} state={{ status_code: [] }}>
                        <div style={{ "float": "left", "margin": "0rem 0.4rem" }}><button className="btn btn-outline-success my-2 my-sm-0" type="button">Search</button></div>
                    </Link>
